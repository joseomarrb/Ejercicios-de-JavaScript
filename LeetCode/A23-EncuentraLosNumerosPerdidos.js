 ...
 * 
 * Tu tarea es escribir una función que, dado un array de números, encuentre todos los números que 
 * faltan entre 1 y n (donde n es el tamaño del array o el número más alto del array).
 * 
