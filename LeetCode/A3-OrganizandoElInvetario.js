 ...
 * Escribe una función que procese este array y devuelva un objeto que organice los juguetes de la
 * siguiente manera:
 *
...
function organizeInventory(inventory) {
    ...
    for (const { category, name, quantity } of inventory) {
        ...
        !object[category].hasOwnProperty(name)
            ? (object[category][name] = quantity)
            : (object[category][name] += quantity);
    }
